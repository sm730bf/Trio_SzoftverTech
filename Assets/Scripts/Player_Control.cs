...
public class Player_Control : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            // Csak akkor mozgunk norm�lisan, ha nincs wall jump cooldown
            if (wallJumpCooldown > 0.2f)
            {
                ...
                else if (!onWall()) // Leveg�ben mozg�s
                {
        ...
        {
            playerBody.gravityScale = 0;
            // Csak f�gg�legesen mozogjon, vagy csak minim�lis v�zszintes mozg�st engedj�nk!
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            // Hozz�adunk +1-et az Y tengelyhez, hogy kicsit magasabbr�l essen le
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        ...
        {
            isClimbing = false;
            playerBody.gravityScale = 3; // Biztons�gi vissza�ll�t�s
        }
    }
    ...
    private void Attack()
    {
        ...
        {
            Debug.Log("Eltal�ltuk: " + enemy.name);
        }
    }
